...
void FuiRDBSelector::setOkCancelDialog(bool yesOrNo)
{
  if (yesOrNo)
  {
    dialogButtons->setButtonLabel(DONE,"OK");
    dialogButtons->setButtonLabel(APPLY,"Apply");
    dialogButtons->setButtonLabel(CANCEL,"Cancel");
  }
  else
  {
    dialogButtons->setButtonLabel(DONE,NULL);
    dialogButtons->setButtonLabel(APPLY,NULL);
    dialogButtons->setButtonLabel(CANCEL,"Close");
  }
}
//----------------------------------------------------------------------------
